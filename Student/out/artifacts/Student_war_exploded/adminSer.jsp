...
<head>
    ...
    <script language="JavaScript" src="js/showService.js"></script>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar hidden-xs">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="adminSer.jsp">维修信息</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="form-horizontal" role="form" action="up" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="xxx" name="pno">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">维修时间</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="rsolve">
                    </div>
                </div>
                <div class="form-group">
