    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar hidden-xs">
            <ul class="nav nav-sidebar">
                ...
                <li  class="active"><a href="s?per=rec">晚归记录</a></li>
            </ul>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="form-horizontal" role="form" action="in" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="学号" name="sno">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="yyyy-mm-dd-hh:mm" name="btime">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">晚归原因</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="晚归原因" name="breason">
                    </div>
                </div>
                <div class="form-group">
